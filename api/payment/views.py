...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id='38p8qrj6rcwd3277',
        public_key='kcbrbvdjg35rrxtt',
        private_key='51405a0cbc740bbbf2531e45e62dc4af'
    )
)
...
def process_payment(request, id, token):
    ...
    device_data_from_the_client = request.POST["deviceData"]
